...
import type { ContactInquiry as _ContactInquiry, ServiceType as _ServiceType, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async searchInquiries(arg0: string): Promise<Array<ContactInquiry>> {
        if (this.processError) {
            try {
    ...
    async submitContactInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ServiceType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactInquiry(arg0, arg1, arg2, arg3, to_candid_ServiceType_n11(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        email: value.email,
        serviceInterest: from_candid_ServiceType_n6(_uploadFile, _downloadFile, value.serviceInterest),
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "entertainment" in value ? ServiceType.entertainment : "security" in value ? ServiceType.security : "networking" in value ? ServiceType.networking : "climateControl" in value ? ServiceType.climateControl : "lighting" in value ? ServiceType.lighting : "energyManagement" in value ? ServiceType.energyManagement : value;
}
...
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.entertainment ? {
        ...
        security: null
    } : value == ServiceType.networking ? {
        networking: null
    } : value == ServiceType.climateControl ? {
        climateControl: null
    } : value == ServiceType.lighting ? {
        lighting: null
    } : value == ServiceType.energyManagement ? {
        energyManagement: null
    } : value;
}

...
import type { ContactSubmission as _ContactSubmission, ServiceType as _ServiceType } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ServiceType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactForm(arg0, arg1, arg2, arg3, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
